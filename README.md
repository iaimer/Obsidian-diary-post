...
- **三层标签系统**：领域 → 主题 → 可选方法，按人生场景生成结构化标签
...
| **条目编辑/删除** | 日记条目使用显式 `⋯` 入口，手机端底部操作面板；图片右上角小号 ✕ 直接删除并同步清理 assets 原图 |
| **过往日记** | 月视图日历，自动预览昨天，选中高亮，小圆点标记有内容日期 |
| **习惯统计** | 近 30 天趋势柱状图和热力图，动态生成标签页 |
| **关于页** | 显示当前版本号，并自动展示 CHANGELOG 当前版本更新内容 |
...
润色风格可自定义；标签分类规则由应用统一维护，详见 [标签规范.md](标签规范.md)。
