...
export function CollapsibleSection({ 
  ...
  return (
    <section className="bg-white dark:bg-gray-800/80 rounded-xl mb-4 overflow-hidden">
      <div
        className="flex justify-between items-center px-4 py-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
