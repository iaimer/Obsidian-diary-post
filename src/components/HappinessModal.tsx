      ...
      <div className="bg-white rounded-xl p-4 w-full max-w-md">
        ...
        {showPolishedPreview ? (
          <div className="mb-3">
            ...
            <div className="p-3 bg-green-50 rounded-lg text-sm text-gray-700 mb-2">
            ...
            <div className="flex gap-2">
              <button
                className="flex-1 px-3 py-2 bg-green-500 text-white rounded-lg text-sm font-medium disabled:bg-green-300"
              ...
              <button
                className="px-3 py-2 bg-green-100 text-green-600 rounded-lg text-sm"
