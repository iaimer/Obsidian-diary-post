      ...
      <div className="bg-white rounded-xl p-4 w-full max-w-md">
        ...
        {showPolishedPreview ? (
          <div className="mb-3">
            ...
            <div className="p-3 bg-yellow-50 rounded-lg text-sm text-gray-700 mb-2">
            ...
            <div className="flex gap-2">
              <button
                className="flex-1 px-3 py-2 bg-yellow-500 text-white rounded-lg text-sm font-medium disabled:bg-yellow-300"
              ...
              <button
                className="px-3 py-2 bg-yellow-100 text-yellow-600 rounded-lg text-sm"
          ...
          <>
            ...
            <div className="flex gap-2 mt-3">
              {isAIConfigured() && (
                <button
                  className="px-3 py-2 bg-purple-100 text-purple-600 rounded-lg text-sm hover:bg-purple-200 disabled:opacity-50"
